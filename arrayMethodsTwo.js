...
numbers.forEach((element, i) => numbers[i] = element / 2)
...
let evenNumbers = numbers.map((element,i)=> numbers[i] = element/2)
...
let citiesI = cities.filter((element, i)=> element.endsWith('i'))
